...
class CheckIfAdmin
{
    ...
    {
        return ($user->active == 1 && (($user->company_id == null && $user->is_admin == 1) || ($user->company_id != null && $user->company->active == 1)));
    }
    ...
    private function respondToUnauthorizedRequest($request)
    {
        if ($request->ajax() || $request->wantsJson()) {
            ...
            return redirect(route('backpack.auth.login'))->withErrors(['email' => 'Oturum zaman aşımına uğradı, lütfen tekrar giriş yapınız.']);
